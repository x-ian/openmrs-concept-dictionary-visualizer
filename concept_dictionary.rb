...
def print_nodes(f)
  @touched_concepts.each do |c|
    f.puts "  \"#{c.concept_id}\" [ label=\"#{concept_name(c)}\", color=\"blue\", style=\"filled\", href=\"http://localhost:8080/openmrs/dictionary/concept.htm?conceptId=3065\"];"
  end
end
...
create_dot [Concept.find(3065)], 'opd_diagnosis.dot', [], 1
create_svg 'opd_diagnosis.dot', 'opd_diagnosis.svg'
